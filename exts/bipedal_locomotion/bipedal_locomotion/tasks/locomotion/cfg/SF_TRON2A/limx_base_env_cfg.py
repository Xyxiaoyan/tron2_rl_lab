...
class SF_TRON2A_SceneCfg(InteractiveSceneCfg):
    ...
    # 前视 D435i RGB-D（挂载在 base_Link 上，limx_imu origin=(0,0,0) 相对 base_Link）
    ...
    # 下视 D435i RGB-D（挂载在 base_Link 上，d435_Link origin=(0.12213,0.01759,0.00599) 相对 limx_imu）
    down_camera = TiledCameraCfg(
        prim_path="{ENV_REGEX_NS}/Robot/base_Link/down_camera",
        offset=TiledCameraCfg.OffsetCfg(pos=(0.12213, 0.01759, 0.00599), rot=(0.2079, 0.0, 0.9781, 0.0), convention="world"),
        data_types=["rgb", "distance_to_image_plane"],
        spawn=sim_utils.PinholeCameraCfg(
            focal_length=11.04,
            horizontal_aperture=20.955,
