...
class WF_TRON2A_CampEnvCfg(WF_TRON2A_BaseEnvCfg):
    def __post_init__(self):
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (0.5, 1.2)  # 只向前
        ...
        self.rewards.base_height_exp = RewTerm(
            ...
            weight=1.0,
            params={"std": math.sqrt(0.05), "stand_height": 0.68, "lookahead": 0.3},
        )
...
@configclass
class WF_TRON2A_StairsEnvCfg(WF_TRON2A_BaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class WF_TRON2A_StairsEnvCfg_PLAY(WF_TRON2A_BaseEnvCfg_PLAY):
    def __post_init__(self):
        super().__post_init__()
